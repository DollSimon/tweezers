...
class TestStandardizeNamesAndVariables:

    def setUp(self):
        self.names = ['xDistConversionT1.VperNm', 'yDistConversionT1.VperNm',
    ...
    def test_validity_of_keys(self):
        names = self.names
        for name in names:
            standardized_name_of(name).should.be.a('str')
