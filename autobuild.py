...
print("Watching changes to the base directory {}".format(BASEDIR))
...
def build_docs():
    ...
    is running...
    """
    print("Build docs at: {}".format(get_now()), file=sys.stderr)
...
def run_unittests():
    ...
    """
    print("Running unit tests at {}".format(get_now()), file=sys.stderr)
    os.chdir(BASEDIR)
