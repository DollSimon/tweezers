...
def check_orientation(edgesImage):
    ...
    verLine = edgesImage[250:251, 1:640]        #Arbitrary vertical line
    horLine = edgesImage[81:541, 250:251]       #Arbitrary horizontal line
...
def get_factor(edgesImage, orientation):
    ...
    #HORIZONTAL
    if orientation == 0:
        c1 = get_edges(edgesImage[81:541, 150:151])
        c2 = get_edges(edgesImage[81:541, 200:201])
        c3 = get_edges(edgesImage[81:541, 250:251])
    ...
    #VERTICAL
        ...
        line1 = edgesImage[150:151, 1:640]
        c1 = get_edges(line1[0])
        line2 = edgesImage[200:201, 1:640]
        c2 = get_edges(line2[0])
        line3 = edgesImage[250:251, 1:640]
...
def factor_collection(collectionPath=os.path.dirname(os.path.realpath(__file__))):
    """
    ...
    #Opening all the images in certain folder
    imageCollection = io.ImageCollection(collectionPath)
    ...
    for indexImage, image in enumerate(imageCollection):
        ...
        edgesImage = filter.canny(image, sigma=3)
    ...
    print("\n xaxix:nm/pix=", np.mean(factorX), "+/-", np.std(factorX),
          "\t yaxix:nm/pix=", np.mean(factorY), "+/-", np.std(factorY))
