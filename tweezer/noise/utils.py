...
def generate_power_noise(alpha=1, nSamples=1e5, normalize=False, deterministic_spectrum=True):
    ...
    :param noramlize: (boolean) whether to map the resulting series to the range [-1, 1]
    :param deterministic_spectrum: (boolean) to switch between deterministic and stochastic distribution of power spectrum (see details)
    
    :return X: (numpy.array) of the signal whose frequency response follows the power law
