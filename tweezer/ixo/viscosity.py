...
def calc_alpha(glycerolMassFraction, temperature=25):
    ...
    :param glycerolMassFraction: Cm in the range [0, 1]
    :param temperature: in Celsius in the range [0, 100]

    :return alpha: power law exponent
    """
...
def calc_glycerol_dynamic_viscosity(temperature=25):
    ...
    :return glycerolDynamicViscosity: Dynamic viscosity of \
    glycerol in [0.001 N s / m^2]
    """
    T = float(temperature)
...
def calc_water_density(temperature):
    ...
    :return waterDensity: Density of water in kg/m^3
    """
...
def calc_glycerol_fraction_by_volume(waterVolume, glycerolVolume):
    ...
    :param waterVolume: volume of water in l
    :param glycerolVolume: volume of glycerol in l

    :return volumeFractionGlycerol: Fraction of glycerol by volume in [0, 1]
    """
    gV = float(glycerolVolume)
...
def calc_water_fraction_by_volume(waterVolume, glycerolVolume):
    ...
    :return volumeFractionWater: Fraction of water by volume in [0, 1]
    """
    gV = float(glycerolVolume)
    wV = float(waterVolume)
