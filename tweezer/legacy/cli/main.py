...
try:
    from tweezer.legacy.cli.help import show_tweezer_help_pages

    from tweezer.legacy.cli.help import (print_plot_help, print_simulate_help,
                                  print_update_help,
                                  print_track_help, print_show_help,
                                  print_list_help, print_analyse_help)

    from tweezer.legacy.core.watcher import run_watcher
    from tweezer.legacy.cli.utils import list_tweezer_files
    from tweezer.legacy.cli import InterpretUserInput
    from tweezer.legacy.cli.utils import pprint_settings, update_settings
    from tweezer import _DEFAULT_SETTINGS
    from tweezer import _TWEEBOT_CONFIG
    from tweezer.legacy.ixo2.json_ import parse_json

    from tweezer.legacy.simulate.brownian_motion import (
        simulate_naive_1D_brownian_motion)

    from tweezer.legacy.ixo2.functions import get_function_arguments

    from tweezer.legacy.cli.plots import (matplotlib_example,
                                   plot_extensible_worm_like_chain)
    from tweezer.legacy.cli.calculations import calc_example, calc_viscosity
